...
public class ItemQtdTest {
	...
	public void inicializarItem() {
		item = new ItemQtd(1, "Papel Higienico limpa mais", "higiene pessoal", 10, "Unidades", "MercadaoTopaTudo",
				2.75);
	}
	...
	public void testToString() {
		assertEquals(item.toString(),
				"1. Papel Higienico limpa mais, higiene pessoal, 10 Unidades, Preco: <MercadaoTopaTudo, R$ 2,75;>");
	}
	...
	public void cadastraItemQtdNegativa() {
		item = new ItemQtd(1, "Papel Higienico limpa mais", "higiene pessoal", -1, "Unidades", "MercadaoTopaTudo",
				2.75);
	}
