...
public class ItemQuiloTest {
	...
	public void testEqualsItensIguais() {
		ItemQuilo item1 = new ItemQuilo(1, "pernil", "alimentos nao industrializados", 0.75, "O Frangao", 6.78);
		ItemQuilo item2 = new ItemQuilo(1, "pernil", "alimentos nao industrializados", 1, "Braza", 8.00);
		assertEquals(true, item1.equals(item2));
	}
	
	@Test
	public void testEqualsItensDiferentes() {
		ItemQuilo item1 = new ItemQuilo(1, "perna de boi", "alimentos nao industrializados", 1, "O Frangao", 8.00);
		ItemQuilo item2 = new ItemQuilo(1, "pernil", "alimentos nao industrializados", 1, "Braza", 8.00);
