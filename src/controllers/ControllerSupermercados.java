...
/**
 * Classe que controla e armazena os supermercados, faz ligacoes com o
...
public class ControllerSupermercados implements Serializable {
	...
	/**
	 * Deleta item de um supermercado. A funcao principal e deletar um item, quando
	 * o mesmo e deletado do sistema.
	 * 
	 * @param id
	 *            Id do item.
	 */
	...
	/**
	 * Metodo que recebe um HashMap com ids e quantidades de itens. Percorre os
	 * supermercados cadastrados e verifica a existencia de cada item Se o item
	 * existir soma no valor de compra do supermercado o valor das quantidades
	 * desejadas do item.
	 * 
	 * Apos armazenar os supermercados que possuem os itens da lista, ordena-os pelo
	 * menor preco e depois retorna um ArrayList para o controller principal.
	 * 
	 * @param itensEQuantidades
	 *            HashMap com ids e quantidades dos itens desejados.
	 * 
	 * @return ArrayList de supermercados com itens desejados, ordenado a partir dos
	 *         valores de compras.
	 */

	public ArrayList<SupermercadoComItensOrdenavel> retornaSuperMercadosComItens(
			HashMap<Integer, Integer> itensEQuantidades) {
		...
		for (SuperMercado supermercado : this.superMercados.values()) {
			...
			if (produtosNoSuperMercado.size() > 0) {
				SuperMercadoComItens novoSuperMercadoComItens = new SuperMercadoComItens(supermercado.getNome(),
						valorTotal, produtosNoSuperMercado);
	 ...
	 * 
	 * @param supermercadosComItens
	 *            ArrayList que vem do controller com os supermercados que possuem
	 *            os itens esse ArrayList é formado por um trabalho em conjunto dos
	 *            controllers de lista e supermercado ligados pelo controller geral.
	 * 
	...
	public String sugereMelhorEstabelecimento(ArrayList<SupermercadoComItensOrdenavel> supermercadosComItens,
			int posicaoSupermercado, int posicaoItem) {
	...
	private boolean verificaPresencaDeSupermercado(String nomeSupermercado) {
		return this.superMercados.containsKey(nomeSupermercado);
	}
