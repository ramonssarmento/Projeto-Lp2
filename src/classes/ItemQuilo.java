...
public class ItemQuilo extends Item {
	 ...
	 * @param categoria, categoria a qual o item pertence
	 * @param kg, quantidade de kg
	 * @param localDeCompra, supermercado o qual o item sera adicionado
	 ...
	 * 
	 * @param valor, valor da quantidade passado
